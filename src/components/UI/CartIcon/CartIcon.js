          ...
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_1_817)">
              ...
              <g clip-path="url(#clip1_1_817)">
                ...
                <text x="13" y="22" fill="white" font-family="'Montserrat', sans-serif" font-size="12" font-weight="bolder"  text-anchor="middle" dominant-baseline="middle">{itemsCount}</text>
              </g>
            </g>
            <defs>
